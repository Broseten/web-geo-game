import { Accordion, AccordionButton, AccordionIcon, AccordionItem, AccordionPanel, Box, Button, Center, Text, VStack } from "@chakra-ui/react";
    ...
    return (
        <Box overflow="auto" width="300px" height="400px" borderRadius="lg">
            <Center>
                ...
                {/* Solution Options */}
                <Accordion allowMultiple maxWidth={300}
                    ...
                    <AccordionItem>
                        <h2>
                            <AccordionButton>
                                <Box flex='1' textAlign='left' fontSize="14px" fontWeight="bold">
                    ...
                    <AccordionItem>
                        <h2>
                            <AccordionButton>
                                <Box flex='1' textAlign='left' fontSize="14px" fontWeight="bold">
                                    Temporary Structures from Recycled Material <br />
                    ...
                    <AccordionItem>
                        <h2>
                            <AccordionButton>
                                <Box flex='1' textAlign='left' fontSize="14px" fontWeight="bold">
                                    AR Enriched Human-place Interaction <br />
                    ...
                    <AccordionItem>
                        <h2>
                            <AccordionButton>
                                <Box flex='1' textAlign='left' fontSize="14px" fontWeight="bold">
                                    Digitally Fabricated Vegetable Garden <br />
                    ...
                    <AccordionItem>
                        <h2>
                            <AccordionButton>
                                <Box flex='1' textAlign='left' fontSize="14px" fontWeight="bold">
                                    Reactivation of Open Spaces through NBS <br />
