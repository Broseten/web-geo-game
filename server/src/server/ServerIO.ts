    ...
    OnClientConnected = (clientSocket: Socket) => {
        ...
        clientSocket.on('create-room', (data: RoomJoined) => {
            ...
            if (roomId) {
                ...
                this.socketServer.sockets.emit('room-list', this.roomManager.getAvailableRoomList(this.GetPlayerID(clientSocket.id)));
        ...
        clientSocket.on('request-room-list', () => {
            clientSocket.emit('room-list', this.roomManager.getAvailableRoomList(this.GetPlayerID(clientSocket.id)));
        });
